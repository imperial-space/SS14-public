...
public sealed class AtmosphericRCDMenuBoundUserInterface : BoundUserInterface
{
    ...
    private static readonly Dictionary<string, (string Tooltip, SpriteSpecifier Sprite)> PrototypesGroupingInfo
        ...
        {
            ["Pipes"] = ("rcd-component-pipes", new SpriteSpecifier.Texture(new ResPath("/Textures/Imperial/Gases/Tools/Atmospheric_RCD/storageFourway.png"))),
            ["Unary"] = ("rcd-component-unary", new SpriteSpecifier.Texture(new ResPath("/Textures/Imperial/Gases/Tools/Atmospheric_RCD/scrubber.png"))),
            ["Trinary"] = ("rcd-component-trinary", new SpriteSpecifier.Texture(new ResPath("/Textures/Imperial/Gases/Tools/Atmospheric_RCD/GasPump.png"))),
            ["Filter"] = ("rcd-component-filter", new SpriteSpecifier.Texture(new ResPath("/Textures/Imperial/Gases/Tools/Atmospheric_RCD/GasFilter.png"))),
        };
    ...
    private IEnumerable<RadialMenuOption> ConvertToButtons(HashSet<ProtoId<AtmosphericRCDPrototype>> prototypes)
    {
