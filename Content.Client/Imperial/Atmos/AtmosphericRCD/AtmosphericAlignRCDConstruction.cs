...
public sealed class AtmosphericAlignRCDConstruction : PlacementMode
{
    [Dependency] private readonly IEntityManager _entityManager = default!;
    [Dependency] private readonly IMapManager _mapManager = default!;
    private readonly SharedMapSystem _mapSystem;
    private readonly AtmosphericRCDSystem _rcdSystem;
    ...
    /// </summary>
    public AtmosphericAlignRCDConstruction(PlacementManager pMan) : base(pMan)
    {
        IoCManager.InjectDependencies(this);
        _mapSystem = _entityManager.System<SharedMapSystem>();
        _rcdSystem = _entityManager.System<AtmosphericRCDSystem>();
    ...
    public override bool IsValidPosition(EntityCoordinates position)
    {
        ...
        if (!_entityManager.TryGetComponent<AtmosphericRCDComponent>(heldEntity, out var rcd))
            return false;
