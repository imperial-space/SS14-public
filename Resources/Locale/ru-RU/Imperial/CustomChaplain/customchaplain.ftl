# God Selection UI
god-selection-window-title = Выбор божества
god-selection-window-description = Выберите божество, которому будете служить:
god-selection-predefined-label = Предопределенные божества:
god-selection-cthulhu-button = Ктулху
god-selection-honk-mother-button = Хонкоматерь
god-selection-technomium-button = Техномиум
god-selection-gray-wave-button = Серая волна
god-selection-custom-label = Собственное божество:
...
god-selection-invalid-characters = Имя содержит недопустимые символы
