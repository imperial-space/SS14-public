...
ent-ClothingUniformJumpskirtRevealingDress = Открытое платье
    .desc = Содержит внушительное количество деталей, хотя все равно не особо прикрывает тело
...
ent-ClothingOuterCloakOfFutureN = Тренч из будущего
    .desc = Темное пальто с короткими рукавами, с переливающейся "N", вышитой на спине
ent-ClothingOuterCloakOfFutureS = Тренч из будущего
    .desc = Темное пальто с короткими рукавами, с переливающейся "S", вышитой на спине
...
ent-ClothingHandMonochromeMimeGloves = Монохромные позолоченные перчатки мима
    .desc = Белая и чёрная пара перчаток, инкрустированные золотом, подчеркивающие статус
