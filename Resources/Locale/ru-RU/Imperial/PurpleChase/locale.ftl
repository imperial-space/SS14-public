...
ent-VlPCPosterOne = Purple Chase | Новые напитки!
    .desc = На этом плакате изображена реклама новых напитков корпорации Purple Chase.

ent-VlPCPosterTwo = Purple Chase | Высшее качество!
    .desc = Корпорация Purple Chase предоставляет посетителям высшего качества не только напитки, но и обслуживание!

ent-VlPCPosterThree = Purple Chase | Обитель безопасности.
    .desc = Несмотря на враждебный космос, именно на объектах корпорации Purple Chase любые существа могут расслабиться и провести время с пользой.

ent-VlPCPosterFour = ОМГ! ПЕЧЕНЬЕ!
    .desc = ОМГ! ПЕЧЕНЬЕ!

ent-VlPCPosterFive = Выбор за тобой!
    .desc = Только ты можешь выбирать то, как разрушить свою печень!

ent-VlPCPosterSix = Твой лучший друг!
    .desc = Зачем тебе друзья, когда есть вино, коньяк, пиво и мартини?

ent-VlPCPosterSeven = ТОСТЫ!
    .desc = Если вы не любите тосты, то вы не человек.

ent-VlPCPosterEight = Purple Chase | Друзья навеки!
    .desc = Если вы не дружите с Purple Chase, значит Purple Chase дружит с вами.

ent-VlPCMusicBoxOne = Музыкальный проигрыватель
    .desc = Играет музыку!

ent-VlPCMusicBoxTwo = Тревожный проигрыватель
    .desc = Когда нужно будет бежать - включите его.

ent-VlPCUniformGeisha = Платье гейши
    .desc = Элигантное платье человека-искусства.

ent-VlPCGeishaBoots = Туфли
    .desc = Красивые туфли гейши.
