...
# Горные акселераторы и улучшения
mining-upgradeable-gun-examine-capacity = Слоты апгрейдов: [color=#aaaaaa]{ $used }/{ $max }%[/color]
mining-upgradeable-gun-popup-capacity-full = Недостаточно слотов для этого апгрейда!
