...
ent-ClothingBackpackDuffelSyndicateEVABundle = набор EVA
    ...
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateRaidBundle = набор рейдовых костюмов синдиката
    .desc = Содержит прочный рейдовый бронекостюм Синдиката.
    .suffix = { "" }
...
ent-ClothingBackpackDuffelSyndicateAmmoFilled = набор боеприпасов
    .desc = Перезаряжаю! Содержит 4 магазина для C-20r, 4 магазина для "AKMS" 4, барабана для "Бульдог" и 2 коробки с патронами для L6 SAW.
