...
ent-DrinkSpaceUpCan = банка спейс-ап
    ...
    .suffix = { "" }
ent-DrinkSolDryCan = банка сол дрю
...
ent-DrinkPwrGameCan = банка pwr game
    ...
    .suffix = { "" }
ent-DrinkNukieCan = крепкий ядерный напиток
    .desc = Обнадеживающий напиток... очень обнадеживающий. Наполнен жидкостью зеленого цвета, после использования рекомендуется обратиться к врачу.
    .suffix = { "" }
ent-DrinkWineCan = банка вина
    .desc = Ваш способ забыть все заботы и весело провести время!
ent-DrinkBeerCan = банка пива
    .desc = Глядит на меня игриво.
ent-DrinkColaCanEmpty = банка колы
    .desc = Прохладительный напиток.
    .suffix = Пустая
