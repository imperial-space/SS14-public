...
ent-Ointment10Lingering = мазь
    .desc = Используется для лечения этих неприятных ожогов. Менее эффективна при кислотных ожогах.
    .suffix = Борги, 10
ent-Brutepack = подорожник
    .desc = Несколько сорованных с обочины листиков подорожника для обработки ран.
    .suffix = { "" }
ent-Brutepack1 = подорожник
    .desc = Несколько сорованных с обочины листиков подорожника для обработки ран.
    .suffix = { "1" }
ent-Brutepack10Lingering = подорожник
    .desc = Несколько сорованных с обочины листиков подорожника для обработки ран.
    .suffix = Борги, 10
ent-Gauze = тряпка для перевязки
    .desc = Грязный бинт, которым можно перевязать кровоточащую культяпку.
    .suffix = { "" }
ent-Gauze10Lingering = тряпка для перевязки
    .desc = Грязный бинт, которым можно перевязать кровоточащую культяпку.
    .suffix = Борги, 10
