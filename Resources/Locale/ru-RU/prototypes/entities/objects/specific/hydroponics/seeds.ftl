...
ent-GalaxythistleSeeds = пакет семян галакточертополоха
    ...
    .suffix = { "" }
ent-GlasstleSeeds = пакет семян стеклянницы
...
ent-MimanaSeeds = пакет семян миман
    .desc = { ent-SeedBase.desc }
ent-DeathNettleSeeds = пакет семян смертокрапив
...
ent-BlueTomatoSeeds = пакет семян синих томатов
    .desc = { ent-SeedBase.desc }
ent-BloodTomatoSeeds = пакет семян кровяных томатов
    .desc = { ent-SeedBase.desc }
...
ent-PyrottonSeeds = пакет семян пироттона
    .desc = { ent-SeedBase.desc }
