...
ent-ClothingOuterCoatDetectiveDark = нуарный плащ
    ...
    .suffix = { "" }
ent-ClothingOuterCoatDetectiveLoadoutGrey = серый тренч детектива
    .desc = Ах, твое верное пальто. Тут и там есть несколько разрывов, что придает ему более современный вид. Или, по крайней мере, так ты себе сказал, когда узнал, что его ремонт обойдется тебе в 200 спео.
    .suffix = { "" }
ent-ClothingOuterCoatDetectiveLoadout = тренч детектива
    .desc = Прочный брезентовый плащ, разработка компании TX Fabrication Corp. Плащ устойчив к внешнему воздействию - идеально подходит для вашей следующей автодефенестрации!
    .suffix = { "" }
