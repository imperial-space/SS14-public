...
ent-SignAiUpload = знак загрузки ИИ
    .desc = Знак, указывающий на установку ИИ.
    .suffix = { "" }
...
ent-SignServer = знак "сервер"
    .desc = Знак, указывающий на сервера.
    .suffix = { "" }
...
ent-SignRobo = знак "робототехника"
    ...
    .suffix = { "" }
ent-SignSecure = знак "служба безопасности"
...
ent-SignZomlab = знак "зомби-лаборатория"
    ...
    .suffix = { "" }
ent-SignSecureMedRed = красный знак "служба безопасности"
    .desc = Знак, предупреждающий что территория впереди является охраняемой зоной.
    .suffix = { "" }
ent-SignSecureSmall = маленький знак "служба безопасности"
    .desc = Знак, предупреждающий что территория впереди является охраняемой зоной.
    .suffix = { "" }
ent-SignSecureSmallRed = маленький красный знак "служба безопасности"
    .desc = Знак, предупреждающий что территория впереди является охраняемой зоной.
    .suffix = { "" }
...
ent-SignCryo = знак "криосон"
    .desc = Вот так, да? Ты собираешься струсить?
    .suffix = { "" }
...
ent-SignReception = знак ресепшена
    .desc = Табличка, обозначающая ресепшен.
ent-SignSalvage = знак "утилизаторы"
    .desc = Знак, указывающий место утилизаторов.
ent-SignCans = знак "канистры"
    .desc = Знак, указывающий на благоприятное присутствие газовых баллонов.
ent-SignKitchen = знак "кухня"
    .desc = Сердце дома. И болезнь.
ent-SignRestroom = знак "туалет"
    .desc = Знак, указывающий, куда вы идете... Что вы здесь делаете?
ent-SignMaterials = знак "материалы"
    .desc = Предзнаменование сочного хранилища из стали, стекла и пластика, которое находится перед вами.
ent-SignTheater = знак "театр"
    .desc = Разве это была бы Космическая станция без драмы?
ent-SignVault = знак "хранилище"
    .desc = Знак, указывающий на хранилище. Кто знает, какие секреты лежат внутри?
