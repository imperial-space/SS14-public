zombie-title = Зомбэ
zombie-description = ААА ЗОМБЭ! ПАУ ПАУ ПОЛУЧАЙ ЗЕЛЁНЫЙ!

zombieteors-title = Зомбоящики
zombieteors-description = На станцию обрушился метеоритный дождь! Объединяйтесь с другими членами экипажа и сделайте всё возможное, чтобы выжить!
...
zombie-shuttle-call = Вы че, коллективно зеленкой решили обмазаться? Отправляю шаттл чтобы вы вернулись домой и отмылись. 
