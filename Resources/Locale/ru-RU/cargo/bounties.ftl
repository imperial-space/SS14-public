...
bounty-item-remains = Останки повелителя улья
...
bounty-description-steak = Повар-вегетарианец отказывается готовить нам что-нибудь из мяса, и ящери начинают беспокоиться. Не могли бы вы тайно доставить нам несколько стейков, чтобы они остались довольны?
...
bounty-description-cardboard-box = Завтра состоится премьера нового спектакля "Кардборги возвращаются", и команда по костюмам к сожалению не готова. Пришлите нам несколько коробок для работы.
...
bounty-item-tooth-sharkminnow = Зуб карпоакулы
bounty-item-flash = Вспышка
bounty-description-tooth-space-carp = Некоторые ребята из «Даун Унда» нуждаются в зубах для создания традиционной одежды. Отправьте им несколько зубов космического карпа.
bounty-description-tooth-sharkminnow = Шеф-повар утверждает, что зубы карпоакулы — это какой-то высококачественный нож. Не знаю, о чем они говорят, но им нужен комплект. Отправьте его им.
