...
{"["}color=gray]Time:[/color] {$time}gray]Time:[/color] {$time}
{"["}color=gray]Round ID:[/color] {$roundId}gray]Round ID:[/color] {$roundId}
{"["}color=gray]Duration:[/color] {$duration}gray]Duration:[/color] {$duration}
{"["}color=gray]ForkId:[/color] {$forkId}gray]ForkId:[/color] {$forkId}
{"["}color=gray]Version:[/color] {$version}gray]Version:[/color] {$version}
{"["}color=gray]Engine:[/color] {$engVersion}gray]Engine:[/color] {$engVersion}
{"["}color=gray]Type Hash:[/color] {$hash}gray]Type Hash:[/color] {$hash}
{"["}color=gray]Comp Hash:[/color] {$compHash}gray]Comp Hash:[/color] {$compHash}
