...
character-setup-gui-character-setup-adminremarks-button = Заметки от администрации
...
character-setup-gui-save-panel-title = Несохраненные изменения персонажей
