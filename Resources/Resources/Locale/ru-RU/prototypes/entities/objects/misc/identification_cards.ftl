...
ent-HoSIDCard = ID карта главы службы безопасности
    .desc = { ent-IDCardStandard.desc }
ent-BrigmedIDCard = ID карта бригмеда
    .desc = { ent-IDCardStandard.desc }
...
ent-NukieAgentIDCard = ID карта пассажира
    .desc = { ent-IDCardStandard.desc }
    .suffix = Ядерная
ent-PunPunIDCard = ID карта ПунПуна
    .desc = { ent-IDCardStandard.desc }
ent-ERTChaplainIDCard = карта священника ОБР
    .desc = { ent-IDCardStandard.desc }
ent-ERTEngineerIDCard = карта инженера ОБР
    .desc = { ent-IDCardStandard.desc }
ent-ERTJanitorIDCard = карта уборщика ОБР
    .desc = { ent-IDCardStandard.desc }
ent-ERTMedicIDCard = карта медика ОБР
    .desc = { ent-IDCardStandard.desc }
