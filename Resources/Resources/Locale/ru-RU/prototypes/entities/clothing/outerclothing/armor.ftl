ent-ClothingOuterArmorReflective = отражающий бронежилет
    ...
    .suffix = { "" }
ent-ClothingOuterArmorRaid = костюм рейдера синдиката
    .desc = Довольно гибкий и хорошо бронированный костюм с мощным наплечным фонариком, выполненный в знаковой кроваво-красной цветовой гамме Gorlex Marauder, он не защищает своего владельца от космоса.
...
ent-ClothingOuterArmorBasic = бронежилет
    .desc = Стандартный бронежилет типа I, который обеспечивает достойную защиту от большинства видов повреждений.
ent-ClothingOuterArmorBasicSlim = бронежилет
    .desc = Легкий бронежилет типа I, который обеспечивает достойную защиту от большинства видов повреждений.
ent-ClothingOuterArmorBone = костяная броня
    .desc = Кажется костянные шутки тут неуместны...
