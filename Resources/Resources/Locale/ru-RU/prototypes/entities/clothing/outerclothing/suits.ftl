...
ent-ClothingOuterSuitJanitorBomb = сапёрный костюм уборщика
    .desc = Тяжелый шлем, предназначенный для того, чтобы выдерживать взрывы, возникающие в результате реакций между химическими веществами, обожаемый уборщиками калий.
ent-ClothingOuterRedRacoon = костюм Енота
    .desc = Пушистый костюм красного Енота
ent-ClothingOuterHardsuitCarp = костюм карпа
    .desc = Специальный костюм, делающий вас похожим на космического карпа, если у смотрящего плохое зрение.
    .suffix = Скафандр, НЕ МАППИТЬ
ent-ClothingOuterSuitWitchRobes = ведьмина мантия
