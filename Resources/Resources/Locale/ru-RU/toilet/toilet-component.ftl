...
toilet-component-suicide-head-message-others = {CAPITALIZE($victim)} засовывает свою голову в {$owner} и жмёт на смыв!
...
plunger-unblock = Вы разблокировали {THE($target)}!
