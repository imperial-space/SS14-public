...
toolshed-verb-mark-description = Помещает этот объект в переменную $marked, список объектов, заменяя его предыдущее значение.
admin-verbs-freeze-and-mute = Заморозить и Замутить
