...
round-end-system-shuttle-already-called-announcement = Эвакуационный шаттл отправился на станцию Центрального Командования!
round-end-system-shuttle-auto-called-announcement = Процедура смены экипажа начата. Шаттл вызван. Он прибудет через: {$time} {$units}. Отзовите шаттл, чтобы продлить смену.
