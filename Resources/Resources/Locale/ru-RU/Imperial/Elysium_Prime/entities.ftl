ent-AirlockMaintElysiumFederation = шлюз Федерации
...
ent-BannerElysiumFederationCommand = знамя Командования
    .desc = Знамя командования Федерации!
ent-BannerElysiumFederationCitizen = знамя Элизиум
    .desc = Знамя граждан Федерации!
ent-BannerElysiumFederationSecurity = знамя Охраны
    .desc = знамя охраны Федерации!

ent-ElysiumFederationIDCard = ID карта Федерации
...
ent-BlackTableReinforcedGlass = стол из бронестекла
    .desc = Квадратный кусок стекла, стоящий на четырех металлических ножках.
ent-BlackSteelChair = стул 
