...
execution-popup-self-initial-internal = Вы приставляете { $weapon } к своему горлу.
execution-popup-self-initial-external = { $attacker } приставляет { $weapon } к своему горлу.
