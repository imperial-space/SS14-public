...
reagent-desc-the-martinez = Легенда бегущего по лезвию. Вспоминается выпивкой, забывается пьяным.

reagent-name-white-gilgamesh = белый гильгамеш
reagent-desc-white-gilgamesh = Отвратительная смесь молока и пива. Создается ощущение, что ты сделан из дерева.

reagent-name-mopwata = мопвата
reagent-desc-mopwata = Грязная, застоявшаяся вода для мытья полов.
