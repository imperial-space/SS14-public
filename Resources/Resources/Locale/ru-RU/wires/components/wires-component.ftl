...
wires-menu-help-popup =
    Нажмите на золотые контакты мультитулом, чтобы запульсировать на их проводе.
    Нажмите на провода кусачками, чтобы отрезать / починить их.

    Индикаторы вверху показывают состояние машины, поэтому возня с проводами, вероятно, может что-то с ними сделать.
    Расположение проводов отличается в каждом раунде, но согласуется между машинами одного типа.
