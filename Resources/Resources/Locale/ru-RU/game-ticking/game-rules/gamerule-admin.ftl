...
starting-rule-selected-preset = Текущие игровые правила: { $preset }
listgamerules-command-help = Показывает все правила, которые были добавлены для текущего раунда.
