...
public sealed partial class ChangeMarkingColortEntityEffectSystem : EntityEffectSystem<MetaDataComponent, ChangeMarkingColor>
{
    [Dependency] private readonly IRobustRandom _random = default!;
    [Dependency] private readonly VisualBodySystem _visualBodySystem = default!;


    protected override void Effect(Entity<MetaDataComponent> entity, ref EntityEffectEvent<ChangeMarkingColor> args)
    {
