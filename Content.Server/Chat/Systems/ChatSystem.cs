...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    public const string DefaultAnnouncementSound = "/Audio/Announcements/announce.ogg"; // Corvax-Announcements
    public const string CentComAnnouncementSound = "/Audio/Announcements/command_report.ogg"; // Corvax-Announcements
